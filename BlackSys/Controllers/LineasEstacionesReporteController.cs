...
{
    public class LineasEstacionesReporteController : Controller
    {

        public static BlackSysEntities db = new BlackSysEntities();

        // GET: LineasEstacionesReporte
        public ActionResult LineasEstacionesReporte()
        {
        ...
        [HttpPost]
        public ActionResult LineasEstacionesReporte(int? idlinea)
        {
        ...
        public JsonResult InsertarLineasEstacionesReporte(List<LineaEstacion> datos)
        {
