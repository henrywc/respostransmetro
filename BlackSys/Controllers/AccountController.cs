...
namespace BlackSys.Controllers
{
    ...
    public class AccountController : Controller
    {
           ...
           var user = await UserManager.FindByNameAsync(model.UserName);
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    logger.Info("Inicio sesion el usuario" + user.UserName + Environment.NewLine + DateTime.Now.AddHours(-6));
        ...
        {
            logger.Info("Ingreso a restrablecer password" + Environment.NewLine + DateTime.Now);
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            AddErrors(result);
            logger.Info("Se modifico el password" + Environment.NewLine + DateTime.Now);
            return View();
        }
        ...
        public async Task<ActionResult> ResetPasswordAdmin(ResetPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                var result = await UserManager.ResetPasswordAsync(user.Id, code, model.Password);
                AddErrors(result);
                logger.Info("Se modifico el password desde el admin" + Environment.NewLine + DateTime.Now);
                return View("ResetPasswordAdmin");
            }
            else {
                logger.Info("El usuario que ingreso no existe" + Environment.NewLine + DateTime.Now);
        ...
        {
            logger.Info("Cerro Sesion el usuairo " + User.Identity.GetUserName() + Environment.NewLine + DateTime.Now);
        ...
        private void AddErrors(IdentityResult result)
        {
            foreach (var error in result.Errors)
            {
                ...
                logger.Info("No se reinicio la contraseña porque " + error + Environment.NewLine + DateTime.Now);
            }
        }
